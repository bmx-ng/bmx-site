...
You can set the 'state' of the random number generator using the [SeedRnd](../../brl/brl.random/trandomdefault/#method-seedrndseedint) command. A common practice is to seed the random number generator with the system time when your program starts up, for example:
```blitzmax
SeedRnd MilliSecs()
```
...
| Type | Description |
|---|---|
| [TRandomDefault](../../brl/brl.random/trandomdefault) | Random number generator |
