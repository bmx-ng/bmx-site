...
The returned driver can be used with [SetGraphicsDriver](../../brl/brl.graphics/#function-setgraphicsdriver-drivertgraphicsdriverdefaultflagslonggraphicsbackbuffer-) to enable OpenGL Max2D rendering.
