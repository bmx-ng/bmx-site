...
structs come in three variations for each dimension: [Double](../../brl/brl.blitz/#double) ( [SVec2D](../../math/math.vector/svec2d), [SVec3D](../../math/math.vector/svec3d), [SVec4D](../../math/math.vector/svec4d)), 
[Float](../../brl/brl.blitz/#float) ( [SVec2F](../../math/math.vector/svec2f), [SVec3F](../../math/math.vector/svec3f), [SVec4F](../../math/math.vector/svec4f)), and [Int](../../brl/brl.blitz/#int) ( [SVec2I](../../math/math.vector/svec2i), [SVec3I](../../math/math.vector/svec3i), [SVec4I](../../math/math.vector/svec4i)).
...
## 2D Vectors
2D vectors are represented by the [SVec2D](../../math/math.vector/svec2d), [SVec2F](../../math/math.vector/svec2f), and [SVec2I](../../math/math.vector/svec2i) structs, each catering to
...
In this example, the playerPos and targetPos are 2D vectors ( [SVec2F](../../math/math.vector/svec2f)) representing the positions of
...
[DistanceTo](../../math/math.vector/svec2d/#method-distancetodoublebsvec2d) method. If the player reaches the target, the target object is moved to a new random position
on the screen.
...
In this example, the `ballPos`, `ballVel`, and ballAcc are 2D vectors ( [SVec2F](../../math/math.vector/svec2f)) representing the ball's position,
...
In this example, the `characterPos` and `targetPos` are 2D vectors ( [SVec2F](../../math/math.vector/svec2f)) representing the
...
In this example, we define a function `CalculateLineLength` that takes two 2D points ( [SVec2D](../../math/math.vector/svec2d)) as
...
## 3D Vectors
3D vectors, represented by the [SVec3D](../../math/math.vector/svec3d), [SVec3F](../../math/math.vector/svec3f), and [SVec3I](../../math/math.vector/svec3i) structs, have three components:
...
## 4D Vectors
4D vectors, represented by the [SVec4D](../../math/math.vector/svec4d), [SVec4F](../../math/math.vector/svec4f), and [SVec4I](../../math/math.vector/svec4i) structs, have four components: x, y, z,
...
transformation matrix to the object's position using the `Apply` method of [SMat4D](../../math/math.matrix/smat4d). The `Get3DPosition`
method converts the 4D vector back to a 3D point by dividing the x, y, and z components by the w component.

We create a TransformableObject and use the [SMat4D](../../math/math.matrix/smat4d) struct functions `Translation`,
...
| Struct | Description |
|---|---|
| [SVec2D](../../math/math.vector/svec2d) | A 2-element structure that can be used to represent positions and directions in 2D-space. |
| [SVec3D](../../math/math.vector/svec3d) | A 3-element structure that can be used to represent positions and directions in 3D-space. |
| [SVec4D](../../math/math.vector/svec4d) | A 4-element structure. |
| [SVec2F](../../math/math.vector/svec2f) | A [Float](../../brl/brl.blitz/#float) backed 2-element structure that can be used to represent positions and directions in 2D-space. |
| [SVec3F](../../math/math.vector/svec3f) | A [Float](../../brl/brl.blitz/#float) backed 3-element structure that can be used to represent positions and directions in 3D-space. |
| [SVec4F](../../math/math.vector/svec4f) | A 4-element structure. |
| [SVec2I](../../math/math.vector/svec2i) | An [Int](../../brl/brl.blitz/#int) backed 2-element structure that can be used to represent positions and directions in 2D-space. |
| [SVec3I](../../math/math.vector/svec3i) | An [Int](../../brl/brl.blitz/#int) backed 3-element structure that can be used to represent positions and directions in 3D-space. |
| [SVec4I](../../math/math.vector/svec4i) | A 4-element structure. |
