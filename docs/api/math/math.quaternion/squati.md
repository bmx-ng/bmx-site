...
Creates a new [SQuatI](../../../math/math.quaternion/squati) from the supplied arguments.
...
Creates a new [SQuatI](../../../math/math.quaternion/squati) from the rotation specified by the <b>euler</b> angle and <b>order</b>.

<br/>

### `Function CreateFromRotation:SQuatI(mat:SMat4I)`

Creates a new [SQuatI](../../../math/math.quaternion/squati) from the rotation component of matrix <b>mat</b>.
