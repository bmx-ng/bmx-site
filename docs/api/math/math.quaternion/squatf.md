...
Creates a new [SQuatF](../../../math/math.quaternion/squatf) from the supplied arguments.
...
Creates a new [SQuatF](../../../math/math.quaternion/squatf) from the rotation specified by the <b>euler</b> angle and <b>order</b>.

<br/>

### `Function CreateFromRotation:SQuatF(mat:SMat4F)`

Creates a new [SQuatD](../../../math/math.quaternion/squatd) from the rotation component of matrix <b>mat</b>.
