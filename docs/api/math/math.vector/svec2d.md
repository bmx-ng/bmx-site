...
Creates a new [SVec2D](../../../math/math.vector/svec2d) from the supplied arguments.
...
For normalized vectors [Dot](../../../math/math.vector/svec2d/#method-dotdoublebsvec2d) returns 1 if they point in exactly the same direction, -1 if they point in completely opposite directions,
