...
Creates a new [SVec2F](../../../math/math.vector/svec2f) from the supplied arguments.
...
For normalized vectors [Dot](../../../math/math.vector/svec2f/#method-dotfloatbsvec2f) returns 1 if they point in exactly the same direction, -1 if they point in completely opposite directions,
