...
Creates a new [SVec2I](../../../math/math.vector/svec2i) from the supplied arguments.
...
For normalized vectors [Dot](../../../math/math.vector/svec2i/#method-dotintbsvec2i) returns 1 if they point in exactly the same direction, -1 if they point in completely opposite directions,
