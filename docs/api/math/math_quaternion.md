...
| Struct | Description |
|---|---|
| [SQuatD](../../math/math.quaternion/squatd) | A Quaternion. |
| [SQuatF](../../math/math.quaternion/squatf) | A [Float](../../brl/brl.blitz/#float) backed Quaternion. |
| [SQuatI](../../math/math.quaternion/squati) | An [Int](../../brl/brl.blitz/#int) backed Quaternion. |

## Enums
| Enum | Description |
|---|---|
| [ERotationOrder](../../math/math.quaternion/erotationorder) | The order in which to apply rotations. |
