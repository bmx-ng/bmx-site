...
sizes and types, such as [SMat2D](../../math/math.matrix/smat2d), [SMat3D](../../math/math.matrix/smat3d), [SMat4D](../../math/math.matrix/smat4d), [SMat2F](../../math/math.matrix/smat2f), [SMat3F](../../math/math.matrix/smat3f), [SMat4F](../../math/math.matrix/smat4f), [SMat2I](../../math/math.matrix/smat2i), [SMat3I](../../math/math.matrix/smat3i), and [SMat4I](../../math/math.matrix/smat4i).
...
### 2x2 Matrices
A 2x2 matrix, represented by the [SMat2D](../../math/math.matrix/smat2d), [SMat2F](../../math/math.matrix/smat2f) and [SMat2I](../../math/math.matrix/smat2i) structs, is primarily used for 2D linear transformations,
...
### 3x3 Matrices
3x3 matrices, represented by the [SMat3D](../../math/math.matrix/smat3d), [SMat3F](../../math/math.matrix/smat3f) and [SMat3I](../../math/math.matrix/smat3i) structs, are commonly used for 3D linear transformations that do
...
### 4x4 Matrices
4x4 matrices, represented by the [SMat4D](../../math/math.matrix/smat4d), [SMat4F](../../math/math.matrix/smat4f) and [SMat4I](../../math/math.matrix/smat4i) structs, are the most versatile and widely used matrices in 3D
...
Here's an example illustrating how to calculate the determinant of a 2x2 matrix using the [SMat2D](../../math/math.matrix/smat2d) struct:
...
calculate the determinant using the `Determinant()` method provided by [SMat2D](../../math/math.matrix/smat2d), and print the resulting
...
Here's an example illustrating how to calculate the determinant of a 3x3 matrix using the [SMat3D](../../math/math.matrix/smat3d) struct:
```blitzmax
SuperStrict
...
calculate the determinant using the `Determinant()` method provided by [SMat3D](../../math/math.matrix/smat3d), and print the
...
Here is an example for finding the inverse of a 2x2 matrix using the [SMat2D](../../math/math.matrix/smat2d) struct:
```blitzmax
SuperStrict
...
And here is an example for finding the inverse of a 3x3 matrix using the [SMat3D](../../math/math.matrix/smat3d) struct:
```blitzmax
SuperStrict
...
Here's an example illustrating how to calculate the transpose of a 2x2 matrix using the [SMat2D](../../math/math.matrix/smat2d) struct.
```blitzmax
SuperStrict
...
the transpose using the Transpose() method provided by the [SMat2D](../../math/math.matrix/smat2d) struct, and print the original
...
And an example for calculating the transpose of a 3x3 matrix using the [SMat3D](../../math/math.matrix/smat3d) struct.
```blitzmax
SuperStrict
...
When you run this example, it will create a 3x3 matrix with the specified elements,
calculate the transpose using the Transpose() method provided by the [SMat3D](../../math/math.matrix/smat3d) struct, and print the
...
#### 2D Vectors ( [SVec2D](../../math/math.vector/svec2d), [SVec2F](../../math/math.vector/svec2f), [SVec2I](../../math/math.vector/svec2i) )
...
#### 3D Vectors ( [SVec3D](../../math/math.vector/svec3d), [SVec3F](../../math/math.vector/svec3f), [SVec3I](../../math/math.vector/svec3i) )
...
| Struct | Description |
|---|---|
| [SMat2D](../../math/math.matrix/smat2d) | A 2x2 Matrix |
| [SMat3D](../../math/math.matrix/smat3d) | A 3x3 matrix. |
| [SMat4D](../../math/math.matrix/smat4d) | A standard 4x4 transformation matrix. |
| [SMat2F](../../math/math.matrix/smat2f) | A [Float](../../brl/brl.blitz/#float) backed 2x2 Matrix. |
| [SMat3F](../../math/math.matrix/smat3f) | A [Float](../../brl/brl.blitz/#float) backed 3x3 matrix. |
| [SMat4F](../../math/math.matrix/smat4f) | A standard [Float](../../brl/brl.blitz/#float) backed 4x4 transformation matrix. |
| [SMat2I](../../math/math.matrix/smat2i) | An [Int](../../brl/brl.blitz/#int) backed 2x2 Matrix. |
| [SMat3I](../../math/math.matrix/smat3i) | An [Int](../../brl/brl.blitz/#int) backed 3x3 matrix. |
| [SMat4I](../../math/math.matrix/smat4i) | A standard [Int](../../brl/brl.blitz/#int) backed 4x4 transformation matrix. |
